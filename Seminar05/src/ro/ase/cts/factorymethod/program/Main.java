...
public class Main {
	...
	public static void main(String[] args) {
		printeazaPersonalSpital(new MedicFactory(), "gigel");
		printeazaPersonalSpital(new AsistentFactory(), "gheorghe");
		printeazaPersonalSpital(new InfirmierFactory(), "vanatorul");
	}
